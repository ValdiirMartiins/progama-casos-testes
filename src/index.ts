...
export type PlanetSituation = "Habitado" | "Habitável" | "Inabitável" | "Inexplorado";

/*Tipagem da das coordenadas do planeta*/
export type PlanetCoordinates = [number, number, number, number];
...
export function weightFormula(gravity: number) {
...
export function addPlanet(name: string, coordinates: PlanetCoordinates, situation: PlanetSituation, atmosphere: number, gravity: number) {
    planets.push({
        name,
        coordinates,
        situation,
...
export const findPlanet = (name: string) => {
...
export function updateSituation(situation: PlanetSituation, planet: Planet) {
...
export function addSatellite(name: string, planet: Planet) {
...
export function removeSatellite(name: string, planet: Planet) {
...
export function promptValidSituation() {
...
export function promptValidPlanet(callbackfn: (planet: Planet) => void) {
    let valid = false;
    while(!valid) {
...
export function firstMenuOption() {
    let valid = false;
...
export function secondMenuOption() {
...
export function thirdMenuOption() {
    promptValidPlanet(planet => {
        let valid = false;
...
export function fourthMenuOption() {
    promptValidPlanet(planet => {
...
export function fifthMenuOption() {
    let list = "Planetas:\n";
...
export function synchronizeSatellites(planet: Planet) {
...
export function sixthMenuOption() {
    promptValidPlanet(planet => {
...
export function seventhMenuOption() {
    promptValidPlanet(planet => {
